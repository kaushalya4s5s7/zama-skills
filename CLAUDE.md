# FHEVM Agent Skills — Claude Code Entry Point
<!-- Validated: @zama-fhe/relayer-sdk ^0.4.2 | @fhevm/solidity ^0.11.1 | 2026-05-11 -->
...
- **Package Manager**: Never use `pnpm` — always use `pnpm` (verify usage in project).
